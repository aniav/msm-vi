...
%obsługa pdfa
\usepackage[usenames,dvipsnames]{color}      %Obsługa kolorów. Opcje usenames i dvipsnames wprowadzają 
%bibliografia
\usepackage{hyperref}
...
\usepackage{listings}  % Source code attachments
...
\defcitealias{gamification} {\cite{gamification} Gamification, Wikipedia}
...
\defcitealias{vrechopoulos} {\cite{vrechopoulos} Vrechopoulos: Virtual Store athmosphere in internet retailing, 2000}
\defcitealias{fogg} {\cite{fogg} Fogg et al.: How do people evaluate a Web site's credibility? Results from a large study, 2002}
\defcitealias{iab} {\cite{iab} Interactive Bureau (IAB): FTSE-100\'s Web sites are still \'wallowing in mediocrity\', 2003}
\defcitealias{mckinsey} {\cite{mckinsey} McKinsey Quarterly: Getting prices right on the Web, 2001}
\defcitealias{nicholls} {\cite{nicholls} Nicholls: The Science of Shopping Cart Abandonment, 2011}
\defcitealias{inzynieria} {\cite{inzynieria} Czerner: Inżynieria oprogramowania, 2011}
\defcitealias{google_seo} {\cite{google_seo} Sisson: Google SEO secrets, 2006}
\defcitealias{ga}{\cite{ga} Google Analytics for NetSuite}
\defcitealias{polldaddy}{\cite{polldaddy} polldaddy.com web 2.0 poll survey results charts} 
\defcitealias{opiniac}{\cite{opiniac} Opiniac.com – subiektywna ocena narzędzia do zbierania opinii użytkowników}
\defcitealias{kampyle}{\cite{kampyle} Customer Feedback with Kampyle and Magento}
\defcitealias{sommerville}{\cite{sommerville} Sommerville: Inżynieria Oprogramowania}
...
\def\literatura{
  ...
  \vspace{-40pt}
    ...
    \bibitem{alreck_settle} {Alreck, P. and Settle, R. B.: Gender Effects on Internet, Catalogue and Store Shopping, Journal of Database Marketing, wydanie 9, nr 2, str. 150-162, 2002}
    ...
    \bibitem{fogg} {Fogg B.G., Soohoo C., Danielson D., Marable L., Stanford J., Tauber E.: How do people evaluate a Web site\'s credibility? Results from a large study, Persuasive Technology Lab, Stanford University, 2002}
    ...
    \bibitem{iab} {Interactive Bureau (IAB): FTSE-100's Web sites are still \'wallowing in mediocrity\', 2003}
    ...
    \bibitem{mckinsey} {McKinsey Quarterly: Getting prices right on the Web, Report No. 2, 2001}
    \bibitem{nicholls} {Nicholls Ch.: The Science of Shopping Cart Abandonment, A research report from The Conversion Academy, 2011}
...
Computers in Human Behavior, wydanie 25, nr 6, str. 1343-54, 2009
    \bibitem{google_seo} Sisson, D.: Google SEO secrets, How to Get a Top Ranking With Search Engine Optimization, 2006
...
Australian DAMA Conference, Melbourne, Victoria, 1996
    \bibitem{vrechopoulos} Vrechopoulos A., O'Keefe R.M., Doukidis G.I.: Virtual Store athmosphere in internet retailing, Proceedings of the 13th international Bled Electronic Commerce Conference, Bled, Slovenia, 12-21 June, 2000
  ...
  \begin{thebibliography}{5}
    \bibitem{kampyle}{Customer Feedback with Kampyle and Magento,
    http://www.magentocommerce.com/blog/customer-feedback-with-kampyle-and-magento/,
    dostęp 01.04.2012}
    \bibitem{inzynieria} {Czerner D.: Inżynieria oprogramowania 2011, 
    http://zasoby.open.agh.edu.pl/\textasciitilde10sdczerner/, dostęp 25.03.2012}
    \bibitem{gamification} {Gamification, http://en.wikipedia.org/wiki/Gamification, 
    dostęp 06.01.2012}
    \bibitem{ga} {Google Analytics for NetSuite, 
    http://www.exploreconsulting.com/netsuite-google-analytics.html, dostęp 01.04.2012}
    \bibitem{opiniac}{Opiniac.com – subiektywna ocena narzędzia do zbierania opinii użytkowników,
    http://www.conversion.pl/blog/opiniac-com/, dostęp 01.04.2012}
    \bibitem{polldaddy}{polldaddy.com web 2.0 poll survey results charts,
    http://www.web20screenshots.com/2010/02/polldaddy-com-web-2-0-poll-survey-results-charts/,
    dostęp 01.04.2012}
    \bibitem{sommerville}{Sommerville I.: Inżynieria Oprogramowania, rozdział 5, 
    www.mif.pg.gda.pl/kft/Rozdz5.ppt}
    \bibitem{census} {QUARTERLY RETAIL E-COMMERCE SALES 4th QUARTER 2008, 
